...
Files Stored in S3 and are extracted in dbt Models
...
**2. Create Python 3.11 virtual environment**
       ...
       •	gpy -3.11 -m venv venv

       •	gvenv\Scripts\activate.bat

**3. Install dbt-duckdb**

       •	gpip install dbt-core==1.6.0
       
       •	gpip install dbt-duckdb==1.6.0
...
**6. Configure AWS credentials**
       ...
       •	gsetx AWS_ACCESS_KEY_ID "<your-access-key>"
       
       •	gsetx AWS_SECRET_ACCESS_KEY "<your-secret-key>"
